...
function Celebrities(){
    ...
    useEffect(()=> {
        async function getData() {
            await axios.get("https://newsapi.org/v2/everything?q=celebrities&apiKey=def8879f67a8461da80185c9ad705fc7")
            .then((response)=> {
        ...
        async function getPopulerData() {
            await axios.get('https://newsapi.org/v2/everything?q=celebrities+populer&apiKey=def8879f67a8461da80185c9ad705fc7')
             .then((response)=> {
